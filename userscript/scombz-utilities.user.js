...
if(location.hostname == 'scombz.shibaura-it.ac.jp'){
    ...
    if(pageBanner){
        ...
        const jsondatastr = (localStorage.getItem("scombzUtilities:settings"))
                                ?JSON.stringify(JSON.parse(decodeURIComponent(localStorage.getItem("scombzUtilities:settings"))), null , "\t")
